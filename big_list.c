...
/*   Updated: 2023/05/16 22:37:37 by ialves-m         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sort_ha(t_sort *s, t_list **ha, t_list **hb)
{
	...
	// if ((b->value < a->value && b->value > s->last_value_a) || (b->value > s->biggest && a->value == s->smallest))
	// 	pa(ha, hb);
	...
	// // 	pa(ha, hb);
	// // }
	// else if ((b->value > a->value && a->value == s->biggest) || (b->value < a->next->value && a->next->value == s->smallest) || (b->value > a->value && b->value < a->next->value))
	// {
	// 	ra(s, ha, 0);
	// 	pa(ha, hb);
	// }
